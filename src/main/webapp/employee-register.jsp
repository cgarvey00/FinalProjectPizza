...
<h1 class="heading">Employee Register</h1>
    ...
    <form action="controller" method="POST">
        <div class="flex">
            <div class="inputBox">
                ...
                <input type="text" class="box" required maxlength="100" placeholder="Enter Name" name="username">
            </div>
            <div class="inputBox">
                ...
                <input type="text" class="box" required maxlength="100" placeholder="Enter Phone Number" name="phoneNumber">
            </div>
            <div class="inputBox">
                <span>Email</span>
        ...
        <br>
        <button type="submit" name="action" value="register" class="add-btn">Register</button>
