...
public class ProductRepositoriesTest {
    ...
    public void testAddProductWhereisSuccessful() {
        ...
        assertTrue(productRep.addProducts(productList));
        ...
        productRep.deleteProduct(productList);
        productRep.resetAutoIncrement("products");
    }
    ...
    public void testUpdateProductWhereItIsSuccessful() {
        ...
        Product p = productRep.findProductByID(3);

        p.setName("New Name");

        assertTrue(productRep.updateProduct(p));
    ...
    void deleteProductIfPresent() {
        ...
        assertTrue(productRep.addProducts(productList));
        assertTrue(productRep.deleteProduct(productList));
        productRep.resetAutoIncrement("products");
    }
    ...
    void deleteProductIfNotPresent() {
        ...
        boolean deletionResult = productRep.deleteProduct(null);
